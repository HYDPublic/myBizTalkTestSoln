		...
		<body bgcolor="#cdcdcd">
			<table border="20" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#444444" width="100%" id="AutoNumber1" height="336">
				...
				<tr>
		          ...
		          <p>Your affiliate value is: <b><xsl:value-of select="//Affiliate"/></b> </p>              
              <p>Your SupplierReference is: <b><xsl:value-of select="//SupplierReference"/></b> </p>
              <p>Your transaction sucess is : <b><xsl:value-of select="//IsSuccess"/></b> </p>
						</font>
					</td>
				</tr>
				<tr>
