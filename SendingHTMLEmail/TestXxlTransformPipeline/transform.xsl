<?xml version="1.0"?>
<xsl:stylesheet version="1.0"  xmlns:yahoo="http://Piksel.MediaServicesFramework.Workflow.Schemas.NoEntry"  xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
    ...
    <html>
		...
		<body bgcolor="#cdcdcd">
			<table border="20" cellpadding="0" cellspacing="0" style="border-collapse: collapse" bordercolor="#444444" width="100%" id="AutoNumber1" height="336">
                ...
                <font face ="Arial Black" color="#663300">This text should be shown</font>
              </b>
						</i>
					</td>
				</tr>
				<tr>
		          ...
		          <p>Your affiliate value is: <b><xsl:value-of select="yahoo:ContentRepository/yahoo:MediaItem/yahoo:AffiliateMediaItems/yahoo:AffiliateMediaItem/@affiliateDomain"/></b> </p>              
              <p>Your SupplierReference is: <b><xsl:value-of select="//ContentRepository//MediaItem//supplierReference"/></b> </p>             
						</font>
					</td>
				</tr>
				<tr>
